...
const itemsByCategory = {
  ...
  "Безалкохолни напитки": [
    { name: "Кока Кола 250 мл.", price: 2 },
    { name: "Фанта 250 мл.", price: 2 },
    { name: "Спрайт 250 мл.", price: 2 },
    { name: "Тоник 250 мл.", price: 2 },
    { name: "Швепс 250 мл.", price: 2 },
    { name: "Сода 250 мл.", price: 2 },
    { name: "Кока Кола 330 мл.", price: 2 },
    { name: "Фанта 330 мл.", price: 2 },
    { name: "Спрайт 330 мл.", price: 2 },
    { name: "Тоник 330 мл.", price: 2 },
    { name: "Швепс 330 мл.", price: 2 },
    { name: "Сода 330 мл.", price: 2 },
    { name: "Кока Кола 500 мл.", price: 2.5 },
    { name: "Фанта 500 мл.", price: 2.5 },
    { name: "Спрайт 500 мл.", price: 2.5 },
  ...
  "Ново меню": [
    { name: "Кордон Блю - цяло бяло месо с шунка и кашкавал", price: 8.9 },
    { name: "Пилешки пръчици с корнфлейкс", price: 5.9 },
    { name: "Кашкавал пане", price: 6.9 },
    { name: "Сирене пане", price: 4.9 },
    { name: "Спаначено кюфте с пармезан", price: 6.9 },
    { name: "Топени сиренца - с корнфлейкс", price: 5.9 },
    { name: "Татарско кюфте - пилешко месо, гъби и кашкавал", price: 6.9 },
    { name: "Шишче от бяло месо с чушка или бекон", price: 6.9 },
    { name: "Мариновани крилца", price: 6.9 },
  ],
};
